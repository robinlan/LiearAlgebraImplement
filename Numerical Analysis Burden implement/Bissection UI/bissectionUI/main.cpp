...
HWND hEdit4; 										 //Store serveaspower bottom number
...
HWND hEdit13; 										 //Store multiply coefficient
HWND hEdit14; 										 //Store nested coefficient
...
string funcStr;										 //To display the current function

string resultRootStr;								 //To display the root finding result
...
bool isMultiply;															//Store if is in multiplying process
int multiplyFuncNum;								 						//Store multiply function number
MultiplyTwoMathFunction multiplyFuncArray[MAXNUM_PER_FUNC];					//Store multiply function objects
bool isNested;																//Store if is in nested process
int nestedFuncNum;										 					//Store nested function number
CalculateAnotherFunctionFirstMathFunction nestedFuncArray[MAXNUM_PER_FUNC]; //Store nested function objects
