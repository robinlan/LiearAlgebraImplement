...
Example usage:
	...
	Global setting:
		...
		TCHAR szRootFindingAppName[] = TEXT("RootFinding") ;
...
HWND createRootFindingWindow(HINSTANCE hThisInstance,TCHAR* szClassName){
	
	WNDCLASSEX wincl;
	/* The Window structure */
    wincl.hInstance = hThisInstance;
    wincl.lpszClassName = szClassName;
    wincl.lpfnWndProc = RootFindingWindowProcedure;      /* This function is called by windows */
    ...
    HWND hwnd = CreateWindowEx (
           ...
           _T("Root Finding App"),       /* Title Text */
